...
원본 출력 PNG를 유지했으며 크기 조정, 자르기, 분할선 보정을 하지 않았습니다. 가로는 1672×941(약 16:9), 세로는 1086×1448이며 sample-11만 1086×1449(약 3:4)입니다. 가로 분할선은 중앙 부근이며 세로 원본 영역은 약 50.0–50.0%입니다. 모두 정확한 50:50 분할은 아닙니다.
