...
# XXD Panel 163｜تكوين ختم مركزي بمساحات لونية
...
ثمانية نماذج من Panel 163، وُلّد كل منها مرة واحدة من مصدر مختلف مع نص إنجليزي قصير. الأفقي 1536×864 بنصفين متساويين يميناً ويساراً، والعمودي 1152×1536 بنصفين متساويين أعلى وأسفل.

تمت مراجعة الموضوع الصغير المركزي والمساحات اللونية المسطحة والبياض الواسع. بعض الألوان باهتة وتفاصيل السيارة أكثر من المطلوب؛ المعروض هو النتائج الفعلية.
...
ختم صغير مركزي من مساحات لونية صافية تحيط به فراغات كبيرة جداً، دون خامات معقدة أو تهشير حبيبي.
...
- `design-only`: تعرض اللوحة الكاملة ترجمة Panel 163 التصميمية فقط، وتبقى الصورة مرجعاً غير ظاهر.
...
بعد التثبيت أعد تشغيل جلسة Agent ثم استدعِ `$xxd-panel-163`. ويمكن إضافة `--global --agent codex --yes` للتثبيت على مستوى المستخدم.

```text
/xxd-panel-163 photo.jpg --mode top-bottom --size 3:4 --text prompt --locale ar-SA
...
راجع [SKILL.md](SKILL.md) لعقد التشغيل الكامل، ومهايئ التشغيل [بالإنجليزية](references/xxd-panel-163-prompt.en.md) أو [بالصينية](references/xxd-panel-163-prompt.zh-CN.md).
