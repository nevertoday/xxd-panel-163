...
保留原生 PNG，未缩放、裁切或修正分界。横图均为 1672×941（约 16:9），竖图为 1086×1448，sample-11 为 1086×1449（约 3:4）。横图分界接近中点；本组竖图原图区约占 50.0–50.0%，不能据此宣称全部严格 50:50。

已检查全部大图与缩略图，并验证元数据清理。以下展示真实生成结果，**不代表全部通过风格验收**。部分主体偏大或偏卡通，帆船、汽车仍保留较多写实细节。
